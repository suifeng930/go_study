...
func InsertHeroNode(head *HeroNode, newHeroNode *HeroNode) {
	...
	newHeroNode.pre = temp //将新结点指向 上一个结点
...
func DeleteHeroNode2(head *HeroNode, deleteId int) {
	temp := head
	flag := false
	for {
		if temp.next == nil { //说明到链表的最后
